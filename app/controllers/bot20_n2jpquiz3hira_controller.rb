# 日本地図都道府県クイズ３択 ひらがな版
# 
class Bot20N2jpquiz3hiraController < ApplicationController
...
"47" => "おきなわ",
  ...
  def client
    @client ||= Line::Bot::Client.new { |config|
      config.channel_secret = "183149a5d6a8adc5af3730890de541eb"
      config.channel_token = "+PqHjqe427MMZmnkc+raGGy57SfYpBBLSnP4PDTGJKGSP4KLLIg1jULf5zUBYAVL0x3o+anvdFhao9knthmDeAqEWZnpuA51OOcnTNrweU5lhI9u5lpMv/++xHB+il/czz706hoPRG8OUm1vNU4fTQdB04t89/1O/w1cDnyilFU="
    }
  end
...
N2日本地図３択幼児向け　は、地図上の都道府県がどの県か３択で回答し続けるアカウントです。
是非末永くご利用ください。
