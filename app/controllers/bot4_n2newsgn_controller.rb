class Bot4N2newsgnController < RssapiController
  ...
  def client
    @client ||= Line::Bot::Client.new { |config|
      config.channel_secret = "3101e0ebf6f93612537d661b14a86774"
      config.channel_token = "s76hsHn7sMZ+1Cxp2mJZ26wDXboDZJQpnsIPvOJxEv6UWLURbg2nAuVdSGObTtMGsE/rwzyIHPV23uLuVUDmnNhNj0ZrD2y/avZGAprTJyslp5AIpQ55BIAPK1jstWa1XCXmEomBukOg0FFQkRAyNQdB04t89/1O/w1cDnyilFU="
    }
  end
